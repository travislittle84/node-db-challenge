...
SQL is a language used to interact with databases. A relational database is a type of database

- [ ] Why do tables need a `primary key`?

Primary key is the unique identifier of the record, it is used to specify records to work with.

- [ ] What is the name given to a table column that references the primary key on another table.
foreign id

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
A junction table with foreign ids for each of the two tables
